      ...
      <div className="flex-1 flex">
        ...
        <div className="w-1/2 flex items-center justify-center p-12 bg-white">
          <div className="w-full max-w-md">
            {/* Login Title */}
            <div className="mb-8">
              <h2 className="text-3xl font-semibold text-[#16325c]">로그인</h2>
            </div>
        ...
        <div className="w-1/2 bg-gradient-to-br from-[#0070d2] to-[#005fb2] relative overflow-hidden flex items-center justify-center">
          ...
          <div className="absolute bottom-1/3 right-32 animate-pulse" style={{ animationDuration: '3s', animationDelay: '1s' }}>
            <div className="w-16 h-20 bg-white/15 backdrop-blur-sm rounded-lg p-2 shadow-lg border border-white/20">
          ...
          <div className="max-w-lg relative z-10 text-white">
            <h1 className="text-4xl font-bold mb-6 text-white">MRO 통합 관리 시스템</h1>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                ...
                <div>
                  <h3 className="font-semibold mb-1 text-white">법인별 통합 관리</h3>
              ...
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                ...
                <div>
                  <h3 className="font-semibold mb-1 text-white">21개 관리항목</h3>
              ...
              <div className="flex items-start gap-3 bg-white/10 backdrop-blur-sm p-4 rounded-xl">
                ...
                <div>
                  <h3 className="font-semibold mb-1 text-white">실시간 모니터링</h3>
